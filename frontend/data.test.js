...
test('retained selection and durable follow-up writes preserve caller identities', async () => {
  ...
  assert.deepEqual(JSON.parse(calls[6].opts.body), { lever: 'late_bolus' }, 'v1 pin remains compatible');
});
