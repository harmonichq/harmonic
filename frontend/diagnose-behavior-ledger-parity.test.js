...
const initialIssued = parseList('S01–S144, C41–C57, C60, and D1–D3');
...
test('Diagnose behavior ledger accepts a permanent retirement', () => {
  const retiredS91 = ledger
    .replace(
      '**Active executable IDs:** S01–S116, S118–S144, C41–C57, C60, and D1–D3',
      '**Active executable IDs:** S01–S90, S92–S116, S118–S144, C41–C57, C60, and D1–D3',
    )
