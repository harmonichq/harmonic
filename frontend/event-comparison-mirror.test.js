...
const COORDINATES = {
  ...
  outcome_not_anchor: { view: 'meals', window: { start_min: 840, end_min: 900 } },
  start_boundary: { view: 'meals', window: { start_min: 455, end_min: 790 } },
  end_boundary: { view: 'meals', window: { start_min: 465, end_min: 780 } },
  end_of_day: { view: 'meals', window: { start_min: 720, end_min: 1440 } },
