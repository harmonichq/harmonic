...
| Plan | The pump-ready staging area: active-profile reference, accepted-change chips, the editable four-parameter deliverable, reconcile, apply history | `shipped` | [#344](https://github.com/harmonichq/harmonic/issues/344) | shipped app: `frontend/index.html` (Plan tab) + `frontend/plan.js` · frozen behavior ledger: `mockups/plan.behavior.md` · app-only replay: `frontend/plan-behavior.replay.mjs` · revised in [#344](https://github.com/harmonichq/harmonic/issues/344): Plan joins the workstation composition as a third host (ADR 344 in `openspec/changes/plan-workstation/design.md`; wireframe renders and base/revision evidence under `openspec/changes/plan-workstation/`) |
