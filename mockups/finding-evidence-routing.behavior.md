...
`frontend/diagnose-workstation-behavior.replay.mjs`: **98 executable entries**
(S01–S80, C41–C55, and D1–D3), all opened through the real no-fetch server and tagged
...
entries**: S01–S77, C41–C55, and D1–D3. The declared no-fetch server read only
...
P24 · ↑/↓ step selected Occurrences through the visible verdict roster and STOP
      ...
      breadcrumb depth, and window; the requested row regains focus after its
      asynchronous case-file render completes.
