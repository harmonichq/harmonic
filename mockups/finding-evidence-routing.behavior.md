...
charts** access. Connor confirmed: "Exactly." The catalog covers the complete
...
S127 is the permanent attributed absence witness for the dock host and dock
state. S128–S131 retain rank-one return, catalog pick, closed initial catalog,
and immediate drill under the direct access path. S139–S144 use the common
priced-row geometry and row-mini policy; no rank is a preview-only state.
