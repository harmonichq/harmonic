...
## Amendment — 2026-09-08, issue #389: remove historical past-setting reads

Sanction: Connor Griffin · 2026-09-08 · “We dont' need historical reads in the app.”
This supersedes prior requirements to show `register=history` tuning reads,
including their Watching disclosure, All Charts membership, counts and selected
case. It retires no source data, current-setting evidence, or Trial/Focus record.

S41, S43–S48, S53–S56, S63–S64 and S68 keep their executable IDs as permanent
attributed absence checks. Each starts with a served historical row and checks
that the past-setting presentation stays absent. The prior story text remains
below as provenance. S42 retains Watching expansion, held/blind membership,
sift preservation and the mobile target. S74 retains default collapse and the
retired footer's absence, using a current held/blind population. Their historical
clauses are superseded. All earlier global-canvas retirements remain in force.
Current-setting loading, replacement, stale-response and non-actionability
obligations remain; v2 HV2-29/HV2-30 and S98 prove them on current I:C evidence.

The amended browser assertions and replay still require execution against the
built app. This amendment records authorization, not a passing verification.
