...
`frontend/diagnose-workstation-behavior.replay.mjs`: **99 executable entries**
(S01–S81, C41–C55, and D1–D3), all opened through the real no-fetch server and tagged
