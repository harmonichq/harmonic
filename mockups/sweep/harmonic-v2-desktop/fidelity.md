...
an acceptance verdict. No c4 browser or image run has occurred. The independent
verifier alone records final behavior/fidelity verdicts and named eye judgments.
...
| HV2-06 | Fixed diagnostic desk | ported | S14/S31/S45/S57/S60/S7b captures | Independent eye reviewer: UNASSIGNED. Named judgment at each size pending. |
...
| HV2-08 | Inter and clinical typography | ported | S9; loaded Inter and computed type capture | Independent eye reviewer: UNASSIGNED. Named judgment at each size pending. |
...
No named eye verdict is supplied by this builder. HV2-06 and HV2-08 each
require the independent reviewer’s name, viewport, inspected capture/live state,
judgment and reason. HV2-09/10/11 and contextual HV2-14 require updated navigation
...
Same-byte pairing has **not** been established. The old prototype reads retained
JSON; the app cases read generated SQLite through the APIs. Their clinical
populations are not asserted identical. Compare unchanged chrome/material only
