...
- [x] 1. Seat every full-rank axis name inside its chart in
...
- [x] 2. Extend the module's own comment record with the full-rank case. The two
...
- [x] 3. Add a regression test to `frontend/diagnose-evidence-charts.test.js`
...
- [x] 4. Re-run the committed measurement driver at
