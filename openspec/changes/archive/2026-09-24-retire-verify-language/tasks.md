...
- [x] 4.1 Replay `ONLY=S169,S170` on the base with this branch's harness laid
  ...
  (`# executed 15 · failed 0`). Renders, coordinator-run 2026-09-24, before on
  ...
  447-A1 (the dock), 447-B1 (Watch maturity, unchanged) and 447-C1 (the Guide
  article), with 447-C2 (the article's Cause line) and 447-B2 (the Trial outcome
  table, review ruling RR1) beside them.
