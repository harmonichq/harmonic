...
- [x] Reproduce both halves against the running no-fetch app on the generated QA
...
- [x] Add a browser regression that fails first for the right reason and then
      ...
      Full control.
- [x] Leave the behavior ledger, its replay, the All charts focus behavior, and
      every other Diagnose behavior unchanged.
- [x] Run the repository's six-command fast gate, the Diagnose workstation
