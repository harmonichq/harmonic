...
- [ ] 2.5 In [#390](https://github.com/harmonichq/harmonic/issues/390), reshape the first release so Diagnose leads with outcome patterns and v2 ships three destinations (Diagnose, Changes, Day).
  - [ ] 2.5.1 [#391](https://github.com/harmonichq/harmonic/issues/391) spike: settle the pattern unit (membership, rate/denominator, impact rule, collapse, subject, opportunity-gated Focus readiness, near-tie); ADR 391 records; read-only aggregate snapshot pass; the unit is named pattern (Connor, 2026-09-08).
