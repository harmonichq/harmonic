...
- [ ] 2.5 In [#390](https://github.com/harmonichq/harmonic/issues/390), reshape the first release so Diagnose leads with outcome patterns and v2 ships three destinations (Diagnose, Changes, Day).
  ...
  - [ ] 2.5.4 [#395](https://github.com/harmonichq/harmonic/issues/395) design child: per-pattern chart and pattern row on the shipped rail; `/ui-craft` revise of the shipped Diagnose surface; Connor holds the lock.
