...
- [ ] 2.2 In [#386](https://github.com/harmonichq/harmonic/issues/386), settle the minimum durable Plan/Trial/Focus context and ending records, canonical Trial identity, legacy unknowns, and one backend finish/admission verdict. Preserve first-observed context for a Trial without a Plan.
  ...
  - [ ] 2.2.2 Reconcile the active singleton, Verify roster, and Focus pin guard through one finish/admission verdict. The synthetic replay must explicitly assert and print its inputs and actual observed/asserted outputs for sequential detected changes, an idempotent repeat finish, a finished latest Trial without old-candidate promotion, a genuinely new change, Plan match versus temporal proximity, manual Focus ending, Trial preemption, and unknown legacy fields; any failed or unexercised case exits nonzero.
