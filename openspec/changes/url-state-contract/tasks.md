...
- [ ] Route the shell's existing shareable page state through the interface
      without adding bookmarkable state.
...
- [ ] Add focused Vue-free tests for parsing, serialization, limited
      normalization, route transitions, and Back/Forward restoration through
