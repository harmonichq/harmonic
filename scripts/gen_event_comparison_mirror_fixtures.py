...
WINDOWS = {
    ...
    "outcome_not_anchor": ComparisonQuery.meals(window=WindowQuery.clock(14 * 60, 15 * 60)),
    "start_boundary": ComparisonQuery.meals(window=WindowQuery.clock(455, 790)),
    "end_boundary": ComparisonQuery.meals(window=WindowQuery.clock(465, 780)),
    "end_of_day": ComparisonQuery.meals(window=WindowQuery.clock(12 * 60, 24 * 60)),
