...
class QaExpectation:
    ...
    outcome_patterns: tuple[dict, ...] = field(kw_only=True)
...
def _pattern_near_tie_recipe(store) -> None:
    _materialize_basal_coverage(store, clean_rate=0.48)
    _materialize_isf_coverage(store, true_isf=48.0)
    _materialize_behavioral_correction_on_iob(store)


def _pattern_collapse_recipe(store) -> None:
    _materialize_behavioral_over_treated_low(store)


def _materialize_sequence(store, *, lever, state):
    ...
    bolus, cgm, log, _ = sequence_episode_stream(
        lever, covered=state == "covered", multi=state == "multiple",
        competitor="severe" if state == "losing" else "mild",
    )
    if state in ("thin-candidate", "thin-reference"):
        evaluation = evaluate_sequences(
            bolus, cgm, log, window_start=cgm[0].t, window_end=cgm[-1].t,
            config=EatingSequenceConfig(),
        )
        cohort = [row for row in evaluation.populations[lever]
                  if row.candidate == (state == "thin-candidate")]
        log = [CarbEntry(row.sequence.end + timedelta(minutes=1), 17.3,
                         "exact", "manual", created_at=row.sequence.end + timedelta(minutes=1))
               for row in cohort[7:]]
...
QA_CASES = (
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Basal 03:00 to 04:00 · lower', 'Carb ratio All day. Past setting.', 'Correction on active insulin', 'Highs after meals', 'Lows after correcting highs', 'Lows after meals', 'Meal bolus fell short', 'Over-treated low', 'Overnight lows with no insulin on board'}),
            {
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 0, 'end_min': 1440, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 32, 'k': 1, 'rate': 0.0312, 'wilson': {'lo': 0.0094, 'hi': 0.0989}, 'rate_producer': 'exposures', 'readiness': {'count': 32, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 0, 'end_min': 1440, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 32, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0488}, 'rate_producer': 'exposures', 'readiness': {'count': 32, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [{'subject': 'habit:over_treated_low', 'kind': 'habit', 'k': 1, 'price': 22, 'admitted': True, 'producer': 'scenario', 'lo': 0.0619, 'hi': 0.4865, 'seriousness': 'low', 'action': 'habit:over_treated_low'}], 'rate_levers': ['habit:over_treated_low'], 'n': 5, 'k': 1, 'rate': 0.2, 'wilson': {'lo': 0.0619, 'hi': 0.4865}, 'rate_producer': 'exposures', 'readiness': {'count': 5, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 22, 'admission_route': 'habit_threshold', 'collapse': 'collapse_to_member', 'action': 'habit:over_treated_low', 'seriousness': 'low', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'a0de7500243ef646'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 5, 'k': 1, 'rate': 0.2, 'wilson': {'lo': 0.0619, 'hi': 0.4865}, 'rate_producer': 'exposures', 'readiness': {'count': 5, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 55, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 55, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            _BEHAVIORAL_ROWS,
            frozenset({'Carb undercount', 'Correction on active insulin', 'Highs after meals', 'Lows after correcting highs', 'Lows after meals', 'Over-treated low', 'Overnight lows with no insulin on board', 'meals-start-high'}),
            {
                ("over_treated_low", "lows"): _verdict_tally(
                    5, fired=1, outranked=1, near_miss=1, no_data=1, clean=1,
                ),
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Basal 03:00 · raise', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 96, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 96, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), frozenset(), {}, frozenset(),
            frozenset({'Basal 03:00 · lower', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 97, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 97, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal",
    ),
    QaCase(
        "basal-capped-raise",
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 7, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.19}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 7, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal", ((180, 240),),
    ),
    QaCase(
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), {}, frozenset(), frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal", ((180, 240),),
    ),
    QaCase(
        "basal-no-baseline",
        partial(
        ...
        QaExpectation(
            ...
            frozenset({("whole_day", ("basal", "03:00"))}),
            frozenset(), {}, frozenset(), frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal", ((180, 240),),
    ),
    QaCase(
        "basal-no-change",
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Basal 03:00 · lower', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 2, 'price': 97, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 180, 'end_min': 210, 'seriousness': 'recurring_low'}], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 30, 'k': 2, 'rate': 0.0667, 'wilson': {'lo': 0.028, 'hi': 0.1503}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 97, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': 'recurring_low', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Basal 05:00 · lower', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 2, 'price': 0, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 300, 'end_min': 330, 'seriousness': 'recurring_low'}], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 2, 'k': 2, 'rate': 1.0, 'wilson': {'lo': 0.5491, 'hi': 1.0}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': 'recurring_low', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 2, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 180, 'end_min': 210, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 2, 'rate': 0.0667, 'wilson': {'lo': 0.028, 'hi': 0.1503}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})), BASAL_SOURCE_SPAN_DAYS, "basal", ((180, 240),),
    ),
    QaCase(
        "isf-strengthen",
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'ISF · strengthen', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 29, 'price': 0, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'isf'}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'isf', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        ISF_SOURCE_SPAN_DAYS,
        "isf",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), _ISF_REST_WINDOWS, {}, _ISF_CORRECTION_ROWS,
            frozenset({'Highs after meals', 'Highs after treating lows', 'ISF · weaken', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 4, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 0, 'end_min': 1440, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        ISF_SOURCE_SPAN_DAYS,
        "isf",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            _ISF_REST_WINDOWS, {}, _ISF_CORRECTION_ROWS, frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 1, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        ISF_SOURCE_SPAN_DAYS,
        "isf",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), {}, _IC_COLLECTING_MEAL_ROWS, frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
        "ic",
        ((0, 720),),
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'I:C 00:00 to 24:00 · raise', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 63, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 63, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 63, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 63, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), frozenset(), {}, _IC_EIGHT_MEAL_ROWS,
            frozenset({'Highs after meals', 'Highs after treating lows', 'I:C 00:00 to 24:00 · lower', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 57, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 57, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 57, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 57, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), frozenset(), {}, _IC_EIGHT_MEAL_ROWS,
            frozenset({'Highs after meals', 'Highs after treating lows', 'I:C 00:00 to 24:00 · raise', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 87, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 87, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 87, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 87, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), frozenset(), {}, _IC_EIGHT_MEAL_ROWS,
            frozenset({'Highs after meals', 'Highs after treating lows', 'I:C 00:00 to 24:00 · lower', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 61, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 61, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 8, 'price': 61, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'carb_ratio'}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 61, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'carb_ratio', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), {}, _IC_NINE_MEAL_ROWS, frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 9, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1543}, 'rate_producer': 'exposures', 'readiness': {'count': 9, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 9, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1543}, 'rate_producer': 'exposures', 'readiness': {'count': 9, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
        ((0, 720),),
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset(), {}, _IC_SEVEN_MEAL_ROWS, frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 7, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.19}, 'rate_producer': 'exposures', 'readiness': {'count': 7, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 7, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.19}, 'rate_producer': 'exposures', 'readiness': {'count': 7, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        IC_SOURCE_SPAN_DAYS,
        "ic",
        ((0, 720),),
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Carb ratio All day. Past setting.', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Carb undercount', 'Highs after meals', 'Highs after treating lows', 'Late bolus', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board', 'meals-start-high'}),
            {
                ("carb_undercount", "meals"): _verdict_tally(
            ...
            2,
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'habit:carb_undercount', 'kind': 'habit', 'k': 2, 'price': 22, 'admitted': True, 'producer': 'scenario', 'lo': 0.1477, 'hi': 0.5906, 'seriousness': 'low', 'action': 'habit:carb_undercount'}, {'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 6, 'k': 3, 'rate': 0.5, 'wilson': {'lo': 0.2682, 'hi': 0.7318}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 22, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:carb_undercount', 'seriousness': 'low', 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '3dbae730bfb75717'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 6, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.2149}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            1,
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'habit:late_bolus', 'kind': 'habit', 'k': 2, 'price': 0, 'admitted': True, 'producer': 'scenario', 'lo': 0.1477, 'hi': 0.5906, 'seriousness': 'info', 'action': 'habit:late_bolus'}, {'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 6, 'k': 3, 'rate': 0.5, 'wilson': {'lo': 0.2682, 'hi': 0.7318}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:late_bolus', 'seriousness': 'info', 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '7b70fc1df4bdda74'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 6, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.2149}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}), {}, uncaused_highs=2,
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        2,
    ),
    QaCase(
        ...
        QaExpectation(
            _explicit_rows({}), {}, {}, frozenset(), frozenset(), {},
            frozenset(), frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        2,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 1, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 2, 'k': 1, 'rate': 0.5, 'wilson': {'lo': 0.1642, 'hi': 0.8358}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        2,
    ),
    QaCase(
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board', 'meals-start-high'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        8,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board', 'carb-counting'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        8,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board', 'post-meal-correction-burden'}),
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'exposures', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 8, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.1703}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 8, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        8,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Carb undercount', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Meal over-delivery', 'Overnight lows with no insulin on board', 'meals-start-high'}),
            {
            ...
            1,
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 0, 'end_min': 1440, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 6, 'k': 1, 'rate': 0.1667, 'wilson': {'lo': 0.0513, 'hi': 0.4253}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'habit:meal_over_delivery', 'kind': 'habit', 'k': 2, 'price': 8, 'admitted': True, 'producer': 'scenario', 'lo': 0.1477, 'hi': 0.5906, 'seriousness': 'info', 'action': 'habit:meal_over_delivery'}, {'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': 'recurring_low', 'seriousness_segments': [{'start_min': 0, 'end_min': 1440, 'seriousness': 'recurring_low'}], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 6, 'k': 2, 'rate': 0.3333, 'wilson': {'lo': 0.1477, 'hi': 0.5906}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 8, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:meal_over_delivery', 'seriousness': 'info', 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '928d6592af5b448a'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Correction stacking', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Missed / unannounced meal', 'Overnight lows with no insulin on board'}),
            {
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'habit:correction_stacking', 'kind': 'habit', 'k': 2, 'price': 16, 'admitted': True, 'producer': 'scenario', 'lo': 0.1253, 'hi': 0.5275, 'seriousness': 'info', 'action': 'habit:correction_stacking'}, {'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 2, 'k': 2, 'rate': 1.0, 'wilson': {'lo': 0.5491, 'hi': 1.0}, 'rate_producer': 'exposures', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 16, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:correction_stacking', 'seriousness': 'info', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': 'd9e58b3c81d3acbf'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            frozenset({'Correction on active insulin', 'Highs after meals', 'Lows after correcting highs', 'Lows after meals', 'Over-treated low', 'Overnight lows with no insulin on board'}),
            {
                ("over_treated_low", "lows"): _verdict_tally(
                    6, fired=2, outranked=1, near_miss=1, no_data=1, clean=1,
                ),
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [{'subject': 'habit:over_treated_low', 'kind': 'habit', 'k': 2, 'price': 28, 'admitted': True, 'producer': 'scenario', 'lo': 0.1477, 'hi': 0.5906, 'seriousness': 'low', 'action': 'habit:over_treated_low'}], 'rate_levers': ['habit:over_treated_low'], 'n': 6, 'k': 2, 'rate': 0.3333, 'wilson': {'lo': 0.1477, 'hi': 0.5906}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 28, 'admission_route': 'habit_threshold', 'collapse': 'collapse_to_member', 'action': 'habit:over_treated_low', 'seriousness': 'low', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'a0de7500243ef646'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 1, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 6, 'k': 1, 'rate': 0.1667, 'wilson': {'lo': 0.0513, 'hi': 0.4253}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 1, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 3, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.3538}, 'rate_producer': 'exposures', 'readiness': {'count': 3, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 3, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.3538}, 'rate_producer': 'exposures', 'readiness': {'count': 3, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [{'subject': 'habit:over_treated_low', 'kind': 'habit', 'k': 1, 'price': 15, 'admitted': True, 'producer': 'scenario', 'lo': 0.0619, 'hi': 0.4865, 'seriousness': 'info', 'action': 'habit:over_treated_low'}], 'rate_levers': ['habit:over_treated_low'], 'n': 5, 'k': 1, 'rate': 0.2, 'wilson': {'lo': 0.0619, 'hi': 0.4865}, 'rate_producer': 'exposures', 'readiness': {'count': 5, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 15, 'admission_route': 'habit_threshold', 'collapse': 'collapse_to_member', 'action': 'habit:over_treated_low', 'seriousness': 'info', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'a0de7500243ef646'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'habit:correction_on_iob', 'kind': 'habit', 'k': 2, 'price': 38, 'admitted': True, 'producer': 'scenario', 'lo': 0.1799, 'hi': 0.6696, 'seriousness': 'medium', 'action': 'habit:correction_on_iob'}, {'subject': 'setting:isf', 'kind': 'setting', 'k': 3, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 5, 'k': 2, 'rate': 0.4, 'wilson': {'lo': 0.1799, 'hi': 0.6696}, 'rate_producer': 'exposures', 'readiness': {'count': 5, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 38, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:correction_on_iob', 'seriousness': 'medium', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 2, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '87828f7c44ee37fb'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
        ...
        QaExpectation(
            ...
            }), frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Meal bolus fell short', 'Missed / unannounced meal', 'Overnight lows with no insulin on board', 'meals-start-high'}), {
                ("missed_meal", "highs"): _verdict_tally(
                    6, fired=2, outranked=1, near_miss=1, no_data=1, clean=1,
                ),
                ("meal_bolus_short", "highs"): _verdict_tally(
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            _BEHAVIORAL_30_DAY_REST_WINDOWS, {}, frozenset({
                ...
                ("correction_clusters", "2024-05-29 11:10:00", "clean"),
            }), frozenset({'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Meal bolus fell short', 'Missed / unannounced meal', 'Overnight lows with no insulin on board'}), {
                ("meal_bolus_short", "highs"): _verdict_tally(
                    6, fired=2, outranked=1, near_miss=1, no_data=1, clean=1,
                ),
                ("missed_meal", "highs"): _verdict_tally(
            ...
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 4, 'k': 2, 'rate': 0.5, 'wilson': {'lo': 0.2302, 'hi': 0.7698}, 'rate_producer': 'exposures', 'readiness': {'count': 4, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 4, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.2911}, 'rate_producer': 'exposures', 'readiness': {'count': 4, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        30,
    ),
    QaCase(
    ...
    QaCase(
        ...
        QaExpectation(
            ...
            }), frozenset({'Carb undercount', 'Highs after meals', 'Highs after treating lows', 'Lows after correcting highs', 'Lows after meals', 'Overnight lows with no insulin on board', 'meals-start-high'}), {
                ("carb_undercount", "meals"): _verdict_tally(
                    1, fired=1, outranked=0, near_miss=0, no_data=0, clean=0,
                ),
            },
            outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 1, 'k': 1, 'rate': 1.0, 'wilson': {'lo': 0.3784, 'hi': 1.0}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [], 'rate_levers': ['habit:over_treated_low'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'e3b0c44298fc1c14'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 0, 'k': 0, 'rate': None, 'wilson': None, 'rate_producer': 'exposures', 'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 2, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.4509}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 2, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'})),
        2,
    ),
    QaCase(
        "pattern-near-tie",
        _pattern_near_tie_recipe,
        QaExpectation(analyzer_rows=ExpectedAnalyzerRows(row_keys=(('basal', '03:00'),), default=None, overrides={('basal', '03:00'): ExpectedBasalRow(safety_status='lower', direction='lower', asserts_move=True, omitted=frozenset())}), support={('basal', '03:00'): ExpectedSupport(directional_support_count=12, n_steps=None, n_runs=None, effective_run_count=None)}, queue_rows={('whole_day', ('basal', '03:00')): ExpectedQueueRow(register='assert', direction='lower', asserts_move=None, headline='One cautious step down is supported at this time. Delivered 0.48 U/h across 12 steady nights against 0.60 programmed.')}, queue_absences=frozenset(), rest_windows=frozenset({('2024-05-31', '2024-05-31 22:00:00', '2024-06-01 08:00:00'), ('2024-05-21', '2024-05-21 22:00:00', '2024-05-22 08:00:00'), ('2024-06-02', '2024-06-02 22:00:00', '2024-06-03 08:00:00'), ('2024-05-18', '2024-05-18 22:00:00', '2024-05-19 08:00:00'), ('2024-05-19', '2024-05-19 22:00:00', '2024-05-20 08:00:00'), ('2024-06-05', '2024-06-05 22:00:00', '2024-06-06 08:00:00'), ('2024-05-26', '2024-05-26 22:00:00', '2024-05-27 08:00:00'), ('2024-05-30', '2024-05-30 22:00:00', '2024-05-31 08:00:00'), ('2024-05-11', '2024-05-11 22:00:00', '2024-05-12 08:00:00'), ('2024-06-03', '2024-06-03 22:00:00', '2024-06-04 08:00:00'), ('2024-05-12', '2024-05-12 22:00:00', '2024-05-13 08:00:00'), ('2024-05-10', '2024-05-10 22:00:00', '2024-05-11 08:00:00'), ('2024-05-27', '2024-05-27 22:00:00', '2024-05-28 08:00:00'), ('2024-05-16', '2024-05-16 22:00:00', '2024-05-17 08:00:00'), ('2024-05-24', '2024-05-24 22:00:00', '2024-05-25 08:00:00'), ('2024-05-28', '2024-05-28 22:00:00', '2024-05-29 08:00:00'), ('2024-05-25', '2024-05-25 22:00:00', '2024-05-26 08:00:00'), ('2024-05-20', '2024-05-20 22:00:00', '2024-05-21 08:00:00'), ('2024-06-04', '2024-06-04 22:00:00', '2024-06-05 08:00:00'), ('2024-06-01', '2024-06-01 22:00:00', '2024-06-02 08:00:00'), ('2024-05-22', '2024-05-22 22:00:00', '2024-05-23 08:00:00'), ('2024-05-13', '2024-05-13 22:00:00', '2024-05-14 08:00:00'), ('2024-05-17', '2024-05-17 22:00:00', '2024-05-18 08:00:00'), ('2024-05-14', '2024-05-14 22:00:00', '2024-05-15 08:00:00'), ('2024-06-07', '2024-06-07 22:00:00', '2024-06-08 08:00:00'), ('2024-05-15', '2024-05-15 22:00:00', '2024-05-16 08:00:00'), ('2024-05-23', '2024-05-23 22:00:00', '2024-05-24 08:00:00'), ('2024-06-06', '2024-06-06 22:00:00', '2024-06-07 08:00:00'), ('2024-05-29', '2024-05-29 22:00:00', '2024-05-30 08:00:00')}), history_series={}, behavioral_rows=frozenset({('correction_clusters', '2024-05-21 00:30:00', 'clean'), ('correction_clusters', '2024-05-27 20:00:00', 'clean'), ('meals', '2024-05-24 19:00:00', 'fired'), ('correction_clusters', '2024-05-17 02:30:00', 'clean'), ('correction_clusters', '2024-06-08 01:30:00', 'clean'), ('correction_clusters', '2024-06-03 23:30:00', 'clean'), ('lows', '2024-05-26 13:55:00', 'fired'), ('highs', '2024-05-26 14:35:00', 'near_miss'), ('correction_clusters', '2024-05-22 01:00:00', 'clean'), ('correction_clusters', '2024-05-23 01:30:00', 'clean'), ('correction_clusters', '2024-05-10 23:30:00', 'clean'), ('correction_clusters', '2024-05-16 02:00:00', 'clean'), ('correction_clusters', '2024-05-26 23:30:00', 'clean'), ('correction_clusters', '2024-05-25 02:30:00', 'clean'), ('correction_clusters', '2024-05-31 01:30:00', 'clean'), ('correction_clusters', '2024-06-06 00:30:00', 'clean'), ('correction_clusters', '2024-06-01 02:00:00', 'clean'), ('correction_clusters', '2024-05-28 00:00:00', 'clean'), ('correction_clusters', '2024-05-15 01:30:00', 'clean'), ('correction_clusters', '2024-05-20 00:00:00', 'clean'), ('lows', '2024-05-24 22:00:00', 'outranked'), ('lows', '2024-05-27 22:00:00', 'near_miss'), ('correction_clusters', '2024-05-25 20:00:00', 'clean'), ('correction_clusters', '2024-05-18 23:30:00', 'clean'), ('lows', '2024-06-02 06:00:00', 'no_data'), ('correction_clusters', '2024-06-07 01:00:00', 'clean'), ('correction_clusters', '2024-05-24 20:00:00', 'clean'), ('lows', '2024-05-28 16:10:00', 'clean'), ('meals', '2024-05-25 19:00:00', 'fired'), ('correction_clusters', '2024-05-30 01:00:00', 'clean'), ('correction_clusters', '2024-05-12 00:00:00', 'clean'), ('correction_clusters', '2024-05-14 01:00:00', 'clean'), ('correction_clusters', '2024-06-02 02:30:00', 'clean'), ('correction_clusters', '2024-05-24 02:00:00', 'clean'), ('correction_clusters', '2024-06-05 00:00:00', 'clean'), ('correction_clusters', '2024-05-13 00:30:00', 'clean'), ('correction_clusters', '2024-05-29 00:30:00', 'clean'), ('lows', '2024-06-01 06:00:00', 'no_data'), ('lows', '2024-05-25 22:00:00', 'outranked'), ('meals', '2024-05-27 19:00:00', 'fired')}), finding_titles=frozenset({'Basal 03:00 · lower', 'Carb undercount', 'Highs after meals', 'Lows after correcting highs', 'Lows after meals', 'Over-treated low', 'Overnight lows with no insulin on board', 'meals-start-high'}), outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'habit:carb_undercount', 'kind': 'habit', 'k': 3, 'price': 72, 'admitted': True, 'producer': 'scenario', 'lo': 0.6462, 'hi': 1.0, 'seriousness': 'high', 'action': 'habit:carb_undercount'}, {'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 3, 'k': 3, 'rate': 1.0, 'wilson': {'lo': 0.6462, 'hi': 1.0}, 'rate_producer': 'exposures', 'readiness': {'count': 3, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 72, 'admission_route': 'habit_threshold', 'collapse': 'remain_pattern', 'action': 'habit:carb_undercount', 'seriousness': 'high', 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '3dbae730bfb75717'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 3, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.3538}, 'rate_producer': 'exposures', 'readiness': {'count': 3, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [{'subject': 'habit:over_treated_low', 'kind': 'habit', 'k': 1, 'price': 14, 'admitted': True, 'producer': 'scenario', 'lo': 0.0513, 'hi': 0.4253, 'seriousness': 'info', 'action': 'habit:over_treated_low'}], 'rate_levers': ['habit:over_treated_low'], 'n': 7, 'k': 1, 'rate': 0.1429, 'wilson': {'lo': 0.0438, 'hi': 0.3777}, 'rate_producer': 'exposures', 'readiness': {'count': 7, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 14, 'admission_route': 'habit_threshold', 'collapse': 'collapse_to_member', 'action': 'habit:over_treated_low', 'seriousness': 'info', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'a0de7500243ef646'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 3, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 7, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.19}, 'rate_producer': 'exposures', 'readiness': {'count': 7, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 52, 'admitted': True, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': 'basal_rate'}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 52, 'admission_route': 'setting_staging', 'collapse': 'remain_pattern', 'action': 'basal_rate', 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'}), verdict_tallies={('carb_undercount', 'meals'): ExpectedVerdictTally(denominator=3, counts={'fired': 3, 'outranked': 0, 'near_miss': 0, 'no_data': 0, 'clean': 0}), ('over_treated_low', 'lows'): ExpectedVerdictTally(denominator=7, counts={'fired': 1, 'outranked': 0, 'near_miss': 0, 'no_data': 2, 'clean': 4})}, uncaused_highs=0),
        39,
    ),
    QaCase(
        "pattern-collapse",
        _pattern_collapse_recipe,
        QaExpectation(analyzer_rows=ExpectedAnalyzerRows(row_keys=(), default=None, overrides={}), support={}, queue_rows={}, queue_absences=frozenset(), rest_windows=frozenset({('2024-05-21', '2024-05-21 22:00:00', '2024-05-22 08:00:00'), ('2024-05-18', '2024-05-18 22:00:00', '2024-05-19 08:00:00'), ('2024-05-19', '2024-05-19 22:00:00', '2024-05-20 08:00:00'), ('2024-05-08', '2024-05-08 22:00:00', '2024-05-09 08:00:00'), ('2024-05-26', '2024-05-26 22:00:00', '2024-05-27 08:00:00'), ('2024-05-11', '2024-05-11 22:00:00', '2024-05-12 08:00:00'), ('2024-05-02', '2024-05-02 22:00:00', '2024-05-03 08:00:00'), ('2024-05-12', '2024-05-12 22:00:00', '2024-05-13 08:00:00'), ('2024-05-10', '2024-05-10 22:00:00', '2024-05-11 08:00:00'), ('2024-05-27', '2024-05-27 22:00:00', '2024-05-28 08:00:00'), ('2024-05-16', '2024-05-16 22:00:00', '2024-05-17 08:00:00'), ('2024-05-24', '2024-05-24 22:00:00', '2024-05-25 08:00:00'), ('2024-05-28', '2024-05-28 22:00:00', '2024-05-29 08:00:00'), ('2024-05-05', '2024-05-05 22:00:00', '2024-05-06 08:00:00'), ('2024-05-25', '2024-05-25 22:00:00', '2024-05-26 08:00:00'), ('2024-05-20', '2024-05-20 22:00:00', '2024-05-21 08:00:00'), ('2024-05-09', '2024-05-09 22:00:00', '2024-05-10 08:00:00'), ('2024-05-06', '2024-05-06 22:00:00', '2024-05-07 08:00:00'), ('2024-05-22', '2024-05-22 22:00:00', '2024-05-23 08:00:00'), ('2024-05-13', '2024-05-13 22:00:00', '2024-05-14 08:00:00'), ('2024-05-17', '2024-05-17 22:00:00', '2024-05-18 08:00:00'), ('2024-05-14', '2024-05-14 22:00:00', '2024-05-15 08:00:00'), ('2024-05-03', '2024-05-03 22:00:00', '2024-05-04 08:00:00'), ('2024-05-07', '2024-05-07 22:00:00', '2024-05-08 08:00:00'), ('2024-05-01', '2024-05-01 22:00:00', '2024-05-02 08:00:00'), ('2024-05-15', '2024-05-15 22:00:00', '2024-05-16 08:00:00'), ('2024-05-04', '2024-05-04 22:00:00', '2024-05-05 08:00:00'), ('2024-05-23', '2024-05-23 22:00:00', '2024-05-24 08:00:00'), ('2024-05-29', '2024-05-29 22:00:00', '2024-05-30 08:00:00')}), history_series={}, behavioral_rows=frozenset({('lows', '2024-05-28 22:00:00', 'fired'), ('meals', '2024-05-28 19:00:00', 'no_data'), ('lows', '2024-05-23 13:55:00', 'fired'), ('lows', '2024-05-27 16:10:00', 'no_data'), ('lows', '2024-05-26 12:10:00', 'clean'), ('highs', '2024-05-23 14:35:00', 'near_miss'), ('lows', '2024-05-25 12:10:00', 'near_miss'), ('correction_clusters', '2024-05-28 20:00:00', 'clean'), ('lows', '2024-05-24 13:55:00', 'fired'), ('highs', '2024-05-24 14:35:00', 'near_miss')}), finding_titles=frozenset({'Correction on active insulin', 'Highs after meals', 'Lows after correcting highs', 'Lows after meals', 'Over-treated low', 'Overnight lows with no insulin on board'}), outcome_patterns=({'key': 'highs_after_meals', 'title': 'Highs after meals', 'subject': 'pattern:highs_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:carb_undercount', 'habit:late_bolus', 'habit:meal_bolus_short'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'lows_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:late_bolus', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:high_carb_sequence', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}, {'habit_subject': 'habit:repeat_eating', 'setting_subject': 'setting:carb_ratio', 'status': 'not_comparable', 'count': None, 'reason': 'different_identity_spaces'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'lows_after_meals', 'title': 'Lows after meals', 'subject': 'pattern:lows_after_meals', 'members': [{'subject': 'setting:carb_ratio', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:meal_over_delivery'], 'n': 1, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.6216}, 'rate_producer': 'exposures', 'readiness': {'count': 1, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'comparable', 'count': 0, 'reason': 'shared_meals_exposure'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery', 'setting_subject': 'setting:carb_ratio', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '13141e472c40a768'}, {'key': 'highs_after_treating_lows', 'title': 'Highs after treating lows', 'subject': 'pattern:highs_after_treating_lows', 'members': [{'subject': 'habit:over_treated_low', 'kind': 'habit', 'k': 2, 'price': 28, 'admitted': True, 'producer': 'scenario', 'lo': 0.1477, 'hi': 0.5906, 'seriousness': 'low', 'action': 'habit:over_treated_low'}], 'rate_levers': ['habit:over_treated_low'], 'n': 6, 'k': 2, 'rate': 0.3333, 'wilson': {'lo': 0.1477, 'hi': 0.5906}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 28, 'admission_route': 'habit_threshold', 'collapse': 'collapse_to_member', 'action': 'habit:over_treated_low', 'seriousness': 'low', 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_correcting_highs': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'a0de7500243ef646'}, {'key': 'lows_after_correcting_highs', 'title': 'Lows after correcting highs', 'subject': 'pattern:lows_after_correcting_highs', 'members': [{'subject': 'setting:isf', 'kind': 'setting', 'k': 1, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': ['habit:correction_stacking', 'habit:correction_on_iob'], 'n': 6, 'k': 1, 'rate': 0.1667, 'wilson': {'lo': 0.0513, 'hi': 0.4253}, 'rate_producer': 'exposures', 'readiness': {'count': 6, 'gate': 12, 'verdict': 'withheld'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'different_exposure_families'}, 'highs_after_treating_lows': {'status': 'comparable', 'count': 0, 'reason': 'shared_lows_exposure'}, 'overnight_lows_no_iob': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 0, 'reason': 'shared_low_episode_nadir'}, {'habit_subject': 'habit:correction_on_iob', 'setting_subject': 'setting:isf', 'status': 'comparable', 'count': 1, 'reason': 'shared_low_episode_nadir'}], 'member_set_fingerprint': '72e37bdefcacb6d7'}, {'key': 'overnight_lows_no_iob', 'title': 'Overnight lows with no insulin on board', 'subject': 'pattern:overnight_lows_no_iob', 'members': [{'subject': 'setting:basal_rate', 'kind': 'setting', 'k': 0, 'price': 0, 'admitted': False, 'producer': 'tuning_levers', 'lo': None, 'hi': None, 'seriousness': None, 'seriousness_segments': [], 'action': None}], 'rate_levers': [], 'n': 30, 'k': 0, 'rate': 0.0, 'wilson': {'lo': 0.0, 'hi': 0.0519}, 'rate_producer': 'harm_band_source_nights', 'readiness': {'count': 30, 'gate': 12, 'verdict': 'ready'}, 'settled_price': 0, 'admission_route': 'none', 'collapse': 'remain_pattern', 'action': None, 'seriousness': None, 'overlap_counts': {'highs_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_meals': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'highs_after_treating_lows': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}, 'lows_after_correcting_highs': {'status': 'not_comparable', 'count': None, 'reason': 'no_habit_exposure_identity'}}, 'harm_low_overlap': [], 'member_set_fingerprint': 'be01b57ca95abd31'}), verdict_tallies={('over_treated_low', 'lows'): ExpectedVerdictTally(denominator=6, counts={'fired': 2, 'outranked': 1, 'near_miss': 1, 'no_data': 1, 'clean': 1}), ('correction_on_iob', 'lows'): ExpectedVerdictTally(denominator=6, counts={'fired': 1, 'outranked': 2, 'near_miss': 0, 'no_data': 0, 'clean': 3})}, uncaused_highs=0),
        30,
    ),
    QaCase(
        'high-carb-sequence-covered',
        partial(_materialize_sequence, lever='high_carb_sequence', state='covered'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                                                                                   asserts_move=None,
                                                                                   headline='No steady '
                                                                                            'nights '
                                                                                            ...
                                                                                            'say either '
                                                                                            'way.'),
                                  ((720, 1080), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                      direction=None,
                                                                                      asserts_move=None,
                                                                                      headline='No steady '
                                                                                               'nights '
                                                                                               ...
                                                                                               'either '
                                                                                               'way.')},
                      queue_absences=frozenset(),
                      rest_windows=frozenset({('2040-01-01', '2040-01-02 00:00:00', '2040-01-02 08:00:00'),
                                              ('2040-01-02', '2040-01-03 00:00:00', '2040-01-03 08:00:00'),
                                              ('2040-01-03', '2040-01-04 00:00:00', '2040-01-04 08:00:00'),
                                              ('2040-01-04', '2040-01-05 00:00:00', '2040-01-05 08:00:00'),
                                              ('2040-01-05', '2040-01-06 00:00:00', '2040-01-06 08:00:00'),
                                              ('2040-01-06', '2040-01-07 00:00:00', '2040-01-07 08:00:00'),
                                              ('2040-01-07', '2040-01-08 00:00:00', '2040-01-08 08:00:00'),
                                              ('2040-01-08', '2040-01-09 00:00:00', '2040-01-09 08:00:00'),
                                              ('2040-01-09', '2040-01-10 00:00:00', '2040-01-10 08:00:00'),
                                              ('2040-01-10', '2040-01-11 00:00:00', '2040-01-11 08:00:00'),
                                              ('2040-01-11', '2040-01-12 00:00:00', '2040-01-12 08:00:00'),
                                              ('2040-01-12', '2040-01-13 00:00:00', '2040-01-13 08:00:00'),
                                              ('2040-01-13', '2040-01-14 00:00:00', '2040-01-14 08:00:00'),
                                              ('2040-01-14', '2040-01-15 00:00:00', '2040-01-15 08:00:00'),
                                              ('2040-01-15', '2040-01-16 00:00:00', '2040-01-16 08:00:00'),
                                              ('2040-01-16', '2040-01-17 00:00:00', '2040-01-17 08:00:00'),
                                              ('2040-01-17', '2040-01-18 00:30:00', '2040-01-18 08:00:00'),
                                              ('2040-01-18', '2040-01-19 00:30:00', '2040-01-19 08:00:00'),
                                              ('2040-01-19', '2040-01-20 00:30:00', '2040-01-20 08:00:00'),
                                              ('2040-01-20',
                                               '2040-01-21 00:30:00',
                                               '2040-01-21 08:00:00')}),
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-17 13:00:00', 'clean'),
                                                 ('highs', '2040-01-18 01:00:00', 'clean'),
                                                 ('highs', '2040-01-18 13:00:00', 'clean'),
                                                 ('highs', '2040-01-19 01:00:00', 'clean'),
                                                 ('highs', '2040-01-19 13:00:00', 'clean'),
                                                 ('highs', '2040-01-20 01:00:00', 'clean'),
                                                 ('highs', '2040-01-20 13:00:00', 'clean'),
                                                 ('highs', '2040-01-21 01:00:00', 'clean'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-04 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-04 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-05 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-05 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-06 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-06 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-07 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-07 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-08 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-08 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-09 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-09 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-10 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-10 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-11 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-11 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-12 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-12 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-13 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-13 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-14 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-14 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-15 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-15 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-16 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-16 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-17 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-17 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-18 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-18 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-19 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-19 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-20 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-20 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-21 00:00:00', 'no_data')}),
                      finding_titles=frozenset({'High-carb sequence',
                                                'Highs after meals',
                                                'Highs after treating lows',
                                                'Lows after correcting highs',
                                                'Lows after meals',
                                                'Missed / unannounced meal',
                                                'Overnight lows with no insulin on board'}),
                      outcome_patterns=({'key': 'highs_after_meals',
                                         'title': 'Highs after meals',
                                         'subject': 'pattern:highs_after_meals',
                                         'members': [{'subject': 'habit:high_carb_sequence',
                                                      'kind': 'habit',
                                                      'k': 8,
                                                      'price': 26,
                                                      'admitted': True,
                                                      ...
                                                      'hi': 0.2922,
                                                      'seriousness': 'low',
                                                      'action': 'habit:high_carb_sequence'},
                                                     {'subject': 'setting:carb_ratio',
                                                      'kind': 'setting',
                                                      'k': 0,
                                                      'price': 0,
                                                      'admitted': False,
                                                      'producer': 'tuning_levers',
                                                      'lo': None,
                                                      'hi': None,
                                                      'seriousness': None,
                                                      'seriousness_segments': [],
                                                      'action': None}],
                                         'rate_levers': ['habit:carb_undercount',
                                                         'habit:late_bolus',
                                                         'habit:meal_bolus_short'],
                                         'n': 40,
                                         'k': 0,
                                         'rate': 0.0,
                                         'wilson': {'lo': 0.0, 'hi': 0.0394},
                                         'rate_producer': 'exposures',
                                         'readiness': {'count': 40, 'gate': 12, 'verdict': 'ready'},
                                         'settled_price': 26,
                                         'admission_route': 'habit_threshold',
                                         'collapse': 'remain_pattern',
                                         'action': 'habit:high_carb_sequence',
                                         'seriousness': 'low',
                                         'overlap_counts': {'lows_after_meals': {'status': 'comparable',
                                                                                 'count': 0,
                                                                                 'reason': 'shared_meals_exposure'},
                                                            'highs_after_treating_lows': {'status': 'not_comparable',
                                                                                          'count': None,
                                                                                          'reason': 'different_exposure_families'},
                                                            'lows_after_correcting_highs': {'status': 'not_comparable',
                                                                                            'count': None,
                                                                                            'reason': 'different_exposure_families'},
                                                            'overnight_lows_no_iob': {'status': 'not_comparable',
                                                                                      'count': None,
                                                                                      'reason': 'no_habit_exposure_identity'}},
                                         'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount',
                                                               'setting_subject': 'setting:carb_ratio',
                                                               'status': 'not_comparable',
                                                               'count': None,
                                                               'reason': 'different_identity_spaces'},
                                                              {'habit_subject': 'habit:late_bolus',
                                                               'setting_subject': 'setting:carb_ratio',
                                                               'status': 'not_comparable',
                                                               'count': None,
                                                               'reason': 'different_identity_spaces'},
                                                              {'habit_subject': 'habit:high_carb_sequence',
                                                               'setting_subject': 'setting:carb_ratio',
                                                               'status': 'not_comparable',
                                                               'count': None,
                                                               'reason': 'different_identity_spaces'},
                                                              {'habit_subject': 'habit:repeat_eating',
                                                               'setting_subject': 'setting:carb_ratio',
                                                               'status': 'not_comparable',
                                                               'count': None,
                                                               'reason': 'different_identity_spaces'}],
                                         'member_set_fingerprint': 'f0bb8ecb52dea906'},
                                        {'key': 'lows_after_meals',
                                         'title': 'Lows after meals',
                                         'subject': 'pattern:lows_after_meals',
                                         'members': [{'subject': 'setting:carb_ratio',
                                                      'kind': 'setting',
                                                      'k': 0,
                                                      'price': 0,
                                                      'admitted': False,
                                                      ...
                                                      'seriousness_segments': [],
                                                      'action': None}],
                                         'rate_levers': ['habit:meal_over_delivery'],
                                         'n': 40,
                                         'k': 0,
                                         'rate': 0.0,
                                         'wilson': {'lo': 0.0, 'hi': 0.0394},
                                         ...
                                         'action': None,
                                         'seriousness': None,
                                         'overlap_counts': {'highs_after_meals': {'status': 'comparable',
                                                                                  'count': 0,
                                                                                  'reason': 'shared_meals_exposure'},
                                                            'highs_after_treating_lows': {'status': 'not_comparable',
                                                                                          'count': None,
                                                            ...
                                                            'overnight_lows_no_iob': {'status': 'not_comparable',
                                                                                      'count': None,
                                                                                      'reason': 'no_habit_exposure_identity'}},
                                         'harm_low_overlap': [{'habit_subject': 'habit:meal_over_delivery',
                                                               'setting_subject': 'setting:carb_ratio',
                                                               'status': 'comparable',
                                                               'count': 0,
                                                               'reason': 'shared_low_episode_nadir'}],
                                         'member_set_fingerprint': '13141e472c40a768'},
                                        {'key': 'highs_after_treating_lows',
                                         'title': 'Highs after treating lows',
                                         'subject': 'pattern:highs_after_treating_lows',
                                         'members': [],
                                         'rate_levers': ['habit:over_treated_low'],
                                         'n': 0,
                                         'k': 0,
                                         'rate': None,
                                         'wilson': None,
                                         'rate_producer': 'exposures',
                                         'readiness': {'count': 0, 'gate': 12, 'verdict': 'withheld'},
                                         'settled_price': 0,
                                         'admission_route': 'none',
                                         'collapse': 'remain_pattern',
                                         'action': None,
                                         'seriousness': None,
                                         'overlap_counts': {'highs_after_meals': {'status': 'not_comparable',
                                                                                  'count': None,
                                                                                  'reason': 'different_exposure_families'},
                                                            'lows_after_meals': {'status': 'not_comparable',
                                                                                 'count': None,
                                                                                 'reason': 'different_exposure_families'},
                                                            'lows_after_correcting_highs': {'status': 'comparable',
                                                                                            'count': 0,
                                                            ...
                                                            'overnight_lows_no_iob': {'status': 'not_comparable',
                                                                                      ...
                                                                                      'reason': 'no_habit_exposure_identity'}},
                                         'harm_low_overlap': [],
                                         'member_set_fingerprint': 'e3b0c44298fc1c14'},
                                        {'key': 'lows_after_correcting_highs',
                                         'title': 'Lows after correcting highs',
                                         'subject': 'pattern:lows_after_correcting_highs',
                                         'members': [{'subject': 'setting:isf',
                                                      'kind': 'setting',
                                                      'k': 0,
                                                      'price': 0,
                                                      'admitted': False,
                                                      ...
                                                      'seriousness_segments': [],
                                                      'action': None}],
                                         'rate_levers': ['habit:correction_stacking',
                                                         'habit:correction_on_iob'],
                                         'n': 0,
                                         'k': 0,
                                         'rate': None,
                                         'wilson': None,
                                         ...
                                         'overlap_counts': {'highs_after_meals': {'status': 'not_comparable',
                                                            ...
                                                            'lows_after_meals': {'status': 'not_comparable',
                                                                                 'count': None,
                                                                                 'reason': 'different_exposure_families'},
                                                            'highs_after_treating_lows': {'status': 'comparable',
                                                                                          'count': 0,
                                                                                          'reason': 'shared_lows_exposure'},
                                                            'overnight_lows_no_iob': {'status': 'not_comparable',
                                                                                      'count': None,
                                                                                      'reason': 'no_habit_exposure_identity'}},
                                         'harm_low_overlap': [{'habit_subject': 'habit:correction_stacking',
                                                              ...
                                                              {'habit_subject': 'habit:correction_on_iob',
                                                               ...
                                                               'count': 0,
                                                               'reason': 'shared_low_episode_nadir'}],
                                         'member_set_fingerprint': '72e37bdefcacb6d7'},
                                        {'key': 'overnight_lows_no_iob',
                                         'title': 'Overnight lows with no insulin on board',
                                         'subject': 'pattern:overnight_lows_no_iob',
                                         'members': [{'subject': 'setting:basal_rate',
                                                      'kind': 'setting',
                                                      'k': 0,
                                                      'price': 0,
                                                      'admitted': False,
                                         ...
                                         'k': 0,
                                         'rate': 0.0,
                                         'wilson': {'lo': 0.0, 'hi': 0.0725},
                                         'rate_producer': 'harm_band_source_nights',
                                         'readiness': {'count': 21, 'gate': 12, 'verdict': 'ready'},
                                         'settled_price': 0,
                                         'admission_route': 'none',
                                         'collapse': 'remain_pattern',
                                         'action': None,
                                         ...
                                         'overlap_counts': {'highs_after_meals': {'status': 'not_comparable',
                                                            ...
                                                            'lows_after_correcting_highs': {'status': 'not_comparable',
                                                                                            ...
                                                                                            'reason': 'no_habit_exposure_identity'}},
                                         'harm_low_overlap': [],
                                         'member_set_fingerprint': 'be01b57ca95abd31'}),
                      verdict_tallies={('high_carb_sequence', 'sequences'): ExpectedVerdictTally(denominator=40,
                                                                                                 counts={'fired': 8,
                                                                                                         'outranked': 0,
                                                                                                         'near_miss': 0,
                                                                                                         'no_data': 0,
                                                                                                         'clean': 32}),
                                       ('missed_meal', 'highs'): ExpectedVerdictTally(denominator=9,
                                                                                      counts={'fired': 1,
                                                                                              'outranked': 0,
                                                                                              'near_miss': 0,
                                                                                              'no_data': 0,
                                                                                              'clean': 8})},
                      uncaused_highs=0),
        21, scoped_windows=((0, 360), (720, 1080)),
    ),
    QaCase(
        'high-carb-sequence-empty',
        partial(_materialize_sequence, lever='high_carb_sequence', state='empty'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      rest_windows=frozenset({('2040-01-01', '2040-01-02 00:00:00', '2040-01-02 08:00:00'),
                                              ...
                                              ('2040-01-15', '2040-01-16 00:00:00', '2040-01-16 08:00:00'),
                                              ('2040-01-16', '2040-01-17 00:00:00', '2040-01-17 08:00:00'),
                                              ('2040-01-17', '2040-01-18 00:00:00', '2040-01-18 08:00:00'),
                                              ('2040-01-18', '2040-01-19 00:00:00', '2040-01-19 08:00:00'),
                                              ('2040-01-19', '2040-01-20 00:00:00', '2040-01-20 08:00:00'),
                                              ('2040-01-20',
                                               '2040-01-21 00:00:00',
                                               '2040-01-21 08:00:00')}),
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-17 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-18 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-18 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-19 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-19 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-20 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-20 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-21 05:30:00', 'outranked'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 00:00:00', 'no_data'),
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='high_carb_sequence', state='thin-candidate'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-17 17:30:00', 'fired'),
                                                 ('highs', '2040-01-18 05:30:00', 'fired'),
                                                 ('highs', '2040-01-18 17:30:00', 'fired'),
                                                 ('highs', '2040-01-19 05:30:00', 'fired'),
                                                 ('highs', '2040-01-19 17:30:00', 'fired'),
                                                 ('highs', '2040-01-20 05:30:00', 'fired'),
                                                 ('highs', '2040-01-20 17:30:00', 'fired'),
                                                 ('highs', '2040-01-21 05:30:00', 'fired'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 00:00:00', 'no_data'),
                                                 ...
                                                 ('meals', '2040-01-20 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-21 00:00:00', 'no_data')}),
                      finding_titles=frozenset({'Highs after meals',
                                                'Highs after treating lows',
                                                'Lows after correcting highs',
                                                'Lows after meals',
                                                'Missed / unannounced meal',
                      ...
                      outcome_patterns=({'key': 'highs_after_meals',
                                        ...
                                        {'key': 'overnight_lows_no_iob',
                                         ...
                                         'harm_low_overlap': [],
                                         'member_set_fingerprint': 'be01b57ca95abd31'}),
                      verdict_tallies={('missed_meal', 'highs'): ExpectedVerdictTally(denominator=9,
                                                                                      counts={'fired': 9,
                                                                                              'outranked': 0,
                                                                                              'near_miss': 0,
                                                                                              'no_data': 0,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='high_carb_sequence', state='thin-reference'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='high_carb_sequence', state='losing'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='high_carb_sequence', state='multiple'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-17 16:05:00', 'outranked'),
                                                 ('highs', '2040-01-17 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-18 04:05:00', 'outranked'),
                                                 ('highs', '2040-01-18 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-18 16:05:00', 'outranked'),
                                                 ('highs', '2040-01-18 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-19 04:05:00', 'outranked'),
                                                 ('highs', '2040-01-19 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-19 16:05:00', 'outranked'),
                                                 ('highs', '2040-01-19 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-20 04:05:00', 'outranked'),
                                                 ('highs', '2040-01-20 05:30:00', 'outranked'),
                                                 ('highs', '2040-01-20 16:05:00', 'outranked'),
                                                 ('highs', '2040-01-20 17:30:00', 'outranked'),
                                                 ('highs', '2040-01-21 04:05:00', 'outranked'),
                                                 ('highs', '2040-01-21 05:30:00', 'outranked'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 00:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
                      ...
                      verdict_tallies={('high_carb_sequence', 'sequences'): ExpectedVerdictTally(denominator=40,
                                                                                                 counts={'fired': 8,
                                                                                                         ...
                                                                                                         'no_data': 0,
                                                                                                         'clean': 32}),
                                       ('missed_meal', 'highs'): ExpectedVerdictTally(denominator=17,
                                                                                      counts={'fired': 17,
                                                                                              'outranked': 0,
                                                                                              'near_miss': 0,
                                                                                              'no_data': 0,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='repeat_eating', state='covered'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                                  ...
                                  ((720, 1080), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                      ...
                                                                                      headline='No steady '
                                                                                               ...
                                                                                               'way.')},
                      queue_absences=frozenset(),
                      rest_windows=frozenset({('2040-01-01', '2040-01-01 22:00:00', '2040-01-02 04:00:00'),
                                              ('2040-01-02', '2040-01-02 22:00:00', '2040-01-03 04:00:00'),
                                              ('2040-01-03', '2040-01-03 22:00:00', '2040-01-04 04:00:00'),
                                              ('2040-01-04', '2040-01-04 22:00:00', '2040-01-05 04:00:00'),
                                              ('2040-01-05', '2040-01-05 22:00:00', '2040-01-06 04:00:00'),
                                              ('2040-01-06', '2040-01-06 22:00:00', '2040-01-07 04:00:00'),
                                              ('2040-01-07', '2040-01-07 22:00:00', '2040-01-08 04:00:00'),
                                              ('2040-01-08', '2040-01-08 22:00:00', '2040-01-09 04:00:00'),
                                              ('2040-01-09', '2040-01-09 22:00:00', '2040-01-10 04:00:00'),
                                              ('2040-01-10', '2040-01-10 22:00:00', '2040-01-11 04:00:00'),
                                              ('2040-01-11', '2040-01-11 22:00:00', '2040-01-12 04:00:00'),
                                              ('2040-01-12', '2040-01-12 22:00:00', '2040-01-13 04:00:00'),
                                              ('2040-01-13', '2040-01-13 22:00:00', '2040-01-14 04:00:00'),
                                              ('2040-01-14', '2040-01-14 22:00:00', '2040-01-15 04:00:00'),
                                              ('2040-01-15', '2040-01-15 22:00:00', '2040-01-16 04:00:00'),
                                              ('2040-01-16', '2040-01-16 22:00:00', '2040-01-17 04:00:00'),
                                              ('2040-01-17', '2040-01-17 22:00:00', '2040-01-18 04:00:00'),
                                              ('2040-01-18', '2040-01-18 22:00:00', '2040-01-19 04:00:00'),
                                              ('2040-01-19', '2040-01-19 22:00:00', '2040-01-20 04:00:00'),
                                              ('2040-01-20', '2040-01-20 22:00:00', '2040-01-21 04:00:00'),
                                              ('2040-01-21', '2040-01-21 22:00:00', '2040-01-22 04:00:00'),
                                              ('2040-01-22', '2040-01-22 22:00:00', '2040-01-23 04:00:00'),
                                              ('2040-01-23', '2040-01-23 22:05:00', '2040-01-24 04:00:00'),
                                              ('2040-01-24', '2040-01-24 22:00:00', '2040-01-25 04:00:00'),
                                              ('2040-01-25', '2040-01-25 22:00:00', '2040-01-26 04:00:00'),
                                              ('2040-01-26',
                                               '2040-01-26 22:00:00',
                                               '2040-01-27 04:00:00')}),
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-22 22:05:00', 'clean'),
                                                 ('highs', '2040-01-23 06:35:00', 'clean'),
                                                 ('highs', '2040-01-23 14:05:00', 'clean'),
                                                 ('highs', '2040-01-23 22:35:00', 'clean'),
                                                 ('highs', '2040-01-24 06:05:00', 'clean'),
                                                 ('highs', '2040-01-24 14:35:00', 'clean'),
                                                 ('highs', '2040-01-24 22:05:00', 'clean'),
                                                 ('highs', '2040-01-25 06:35:00', 'clean'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-01 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-03 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-04 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-04 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-04 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-05 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-05 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-05 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-06 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-06 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-06 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-07 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-07 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-07 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-08 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-08 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-08 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-09 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-09 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-09 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-10 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-10 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-10 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-11 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-11 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-11 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-12 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-12 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-12 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-13 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-13 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-13 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-14 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-14 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-14 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-15 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-15 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-15 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-16 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-16 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-16 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-17 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-17 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-17 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-18 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-18 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-18 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-19 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-19 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-19 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-20 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-20 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-20 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-21 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-21 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-21 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-22 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-22 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-22 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-22 20:31:00', 'no_data'),
                                                 ('meals', '2040-01-22 21:02:00', 'no_data'),
                                                 ('meals', '2040-01-23 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-23 04:31:00', 'no_data'),
                                                 ('meals', '2040-01-23 05:02:00', 'no_data'),
                                                 ('meals', '2040-01-23 05:33:00', 'no_data'),
                                                 ('meals', '2040-01-23 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-23 12:31:00', 'no_data'),
                                                 ('meals', '2040-01-23 13:02:00', 'no_data'),
                                                 ('meals', '2040-01-23 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-23 20:31:00', 'no_data'),
                                                 ('meals', '2040-01-23 21:02:00', 'no_data'),
                                                 ('meals', '2040-01-23 21:33:00', 'no_data'),
                                                 ('meals', '2040-01-24 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-24 04:31:00', 'no_data'),
                                                 ('meals', '2040-01-24 05:02:00', 'no_data'),
                                                 ('meals', '2040-01-24 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-24 12:31:00', 'no_data'),
                                                 ('meals', '2040-01-24 13:02:00', 'no_data'),
                                                 ('meals', '2040-01-24 13:33:00', 'no_data'),
                                                 ('meals', '2040-01-24 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-24 20:31:00', 'no_data'),
                                                 ('meals', '2040-01-24 21:02:00', 'no_data'),
                                                 ('meals', '2040-01-25 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-25 04:31:00', 'no_data'),
                                                 ('meals', '2040-01-25 05:02:00', 'no_data'),
                                                 ('meals', '2040-01-25 05:33:00', 'no_data'),
                                                 ('meals', '2040-01-25 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-25 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-26 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-26 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-26 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-27 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-27 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-27 20:00:00', 'no_data')}),
                      finding_titles=frozenset({'Highs after meals',
                                                'Highs after treating lows',
                                                'Lows after correcting highs',
                                                'Lows after meals',
                      ...
                      outcome_patterns=({'key': 'highs_after_meals',
                                         'title': 'Highs after meals',
                                         'subject': 'pattern:highs_after_meals',
                                         'members': [{'subject': 'habit:repeat_eating',
                                                      'kind': 'habit',
                                                      'k': 8,
                                                      'price': 43,
                                                      'admitted': True,
                                         ...
                                         'k': 0,
                                         'rate': 0.0,
                                         'wilson': {'lo': 0.0, 'hi': 0.0162},
                                         'rate_producer': 'exposures',
                                         'readiness': {'count': 100, 'gate': 12, 'verdict': 'ready'},
                                         'settled_price': 43,
                                         'admission_route': 'habit_threshold',
                                         'collapse': 'remain_pattern',
                                         'action': 'habit:repeat_eating',
                                         ...
                                         'harm_low_overlap': [{'habit_subject': 'habit:carb_undercount',
                                                              ...
                                                              {'habit_subject': 'habit:repeat_eating',
                                                               ...
                                                               'count': None,
                                                               'reason': 'different_identity_spaces'}],
                                         'member_set_fingerprint': '3403ba8cb2840666'},
                                        {'key': 'lows_after_meals',
                                         'title': 'Lows after meals',
                                         'subject': 'pattern:lows_after_meals',
                                         'members': [{'subject': 'setting:carb_ratio',
                                        ...
                                        {'key': 'overnight_lows_no_iob',
                                         ...
                                         'k': 0,
                                         'rate': 0.0,
                                         'wilson': {'lo': 0.0, 'hi': 0.0554},
                                         'rate_producer': 'harm_band_source_nights',
                                         'readiness': {'count': 28, 'gate': 12, 'verdict': 'ready'},
                                         'settled_price': 0,
                                         'admission_route': 'none',
                                         'collapse': 'remain_pattern',
                                         'action': None,
                                         ...
                                         'harm_low_overlap': [],
                                         'member_set_fingerprint': 'be01b57ca95abd31'}),
                      verdict_tallies={('repeat_eating', 'sequences'): ExpectedVerdictTally(denominator=16,
                                                                                            counts={'fired': 8,
                                                                                                    'outranked': 0,
                                                                                                    'near_miss': 0,
                                                                                                    'no_data': 0,
                                       ...
                                       ('missed_meal', 'highs'): ExpectedVerdictTally(denominator=9,
                                                                                      counts={'fired': 1,
                                                                                              ...
                                                                                              'clean': 8})},
                      uncaused_highs=0),
        28, scoped_windows=((0, 360), (720, 1080)),
    ),
    QaCase(
        'repeat-eating-empty',
        partial(_materialize_sequence, lever='repeat_eating', state='empty'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      rest_windows=frozenset({('2040-01-01', '2040-01-01 22:00:00', '2040-01-02 04:00:00'),
                                              ...
                                              ('2040-01-21', '2040-01-21 22:00:00', '2040-01-22 04:00:00'),
                                              ('2040-01-22', '2040-01-22 22:00:00', '2040-01-23 04:00:00'),
                                              ('2040-01-23', '2040-01-23 22:00:00', '2040-01-24 03:00:00'),
                                              ('2040-01-24', '2040-01-24 22:00:00', '2040-01-25 04:00:00'),
                                              ('2040-01-25', '2040-01-25 22:00:00', '2040-01-26 04:00:00'),
                                              ('2040-01-26',
                                               '2040-01-26 22:00:00',
                      ...
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-23 02:35:00', 'outranked'),
                                                 ('highs', '2040-01-23 11:05:00', 'outranked'),
                                                 ('highs', '2040-01-23 18:35:00', 'outranked'),
                                                 ('highs', '2040-01-24 03:05:00', 'outranked'),
                                                 ('highs', '2040-01-24 10:35:00', 'outranked'),
                                                 ('highs', '2040-01-24 19:05:00', 'outranked'),
                                                 ('highs', '2040-01-25 02:35:00', 'outranked'),
                                                 ('highs', '2040-01-25 11:05:00', 'outranked'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-01 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='repeat_eating', state='thin-candidate'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-23 02:35:00', 'fired'),
                                                 ('highs', '2040-01-23 11:05:00', 'fired'),
                                                 ('highs', '2040-01-23 18:35:00', 'fired'),
                                                 ('highs', '2040-01-24 03:05:00', 'fired'),
                                                 ('highs', '2040-01-24 10:35:00', 'fired'),
                                                 ('highs', '2040-01-24 19:05:00', 'fired'),
                                                 ('highs', '2040-01-25 02:35:00', 'fired'),
                                                 ('highs', '2040-01-25 11:05:00', 'fired'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-01 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 04:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 12:00:00', 'no_data'),
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='repeat_eating', state='thin-reference'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      outcome_patterns=({'key': 'highs_after_meals',
                                        ...
                                        {'key': 'overnight_lows_no_iob',
                                         ...
                                         'harm_low_overlap': [],
                                         'member_set_fingerprint': 'be01b57ca95abd31'}),
                      verdict_tallies={('high_carb_sequence', 'sequences'): ExpectedVerdictTally(denominator=79,
                                                                                                 counts={'fired': 8,
                                                                                                         'outranked': 0,
                                                                                                         'near_miss': 0,
                                                                                                         'no_data': 0,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='repeat_eating', state='losing'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
    ...
    QaCase(
        ...
        partial(_materialize_sequence, lever='repeat_eating', state='multiple'),
        QaExpectation(analyzer_rows={},
                      support={},
                      queue_rows={((0, 360), ('basal', '00:00')): ExpectedQueueRow(register='blind',
                                                                                   direction=None,
                      ...
                      history_series={},
                      behavioral_rows=frozenset({('highs', '2040-01-01 00:30:00', 'fired'),
                                                 ('highs', '2040-01-23 01:10:00', 'outranked'),
                                                 ('highs', '2040-01-23 02:35:00', 'outranked'),
                                                 ('highs', '2040-01-23 09:40:00', 'outranked'),
                                                 ('highs', '2040-01-23 11:05:00', 'outranked'),
                                                 ('highs', '2040-01-23 17:10:00', 'outranked'),
                                                 ('highs', '2040-01-23 18:35:00', 'outranked'),
                                                 ('highs', '2040-01-24 01:40:00', 'outranked'),
                                                 ('highs', '2040-01-24 03:05:00', 'outranked'),
                                                 ('highs', '2040-01-24 09:10:00', 'outranked'),
                                                 ('highs', '2040-01-24 10:35:00', 'outranked'),
                                                 ('highs', '2040-01-24 17:40:00', 'outranked'),
                                                 ('highs', '2040-01-24 19:05:00', 'outranked'),
                                                 ('highs', '2040-01-25 01:10:00', 'outranked'),
                                                 ('highs', '2040-01-25 02:35:00', 'outranked'),
                                                 ('highs', '2040-01-25 09:40:00', 'outranked'),
                                                 ('highs', '2040-01-25 11:05:00', 'outranked'),
                                                 ('meals', '2040-01-01 12:00:00', 'no_data'),
                                                 ('meals', '2040-01-01 20:00:00', 'no_data'),
                                                 ('meals', '2040-01-02 04:00:00', 'no_data'),
...
def assert_expectation(case: QaCase, execution: QaExecution) -> None:
    ...
    if not case.expectation.outcome_patterns:
        raise AssertionError(f"{case.name}: missing literal outcome_patterns expectation")
    if execution.outcome_patterns != case.expectation.outcome_patterns:
        raise AssertionError(f"{case.name}: outcome_patterns differ")
    ...
    for key, expected in case.expectation.verdict_tallies.items():
        ...
        if family == "sequences":
            assert expected.denominator == len(
                execution.exposures["sequence_evidence"][lever]["population"])
        else:
